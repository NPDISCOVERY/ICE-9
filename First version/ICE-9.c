...
#define cemailto "youremail"
#define cemailfrom "anotheremailiguess"
#define LogLength 100
#define FileName "whatever.extension"
#define SMTPLog "idk.extension"
#define cemailsubject "thesubject"
